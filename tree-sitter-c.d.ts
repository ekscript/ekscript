...
export interface AssignmentExpressionNode extends NamedNodeBase {
  ...
  leftNode: CallExpressionNode | FieldExpressionNode | IdentifierNode | ParenthesizedExpressionNode | PointerExpressionNode | SubscriptExpressionNode;
...
export interface BinaryExpressionNode extends NamedNodeBase {
  ...
  operatorNode: UnnamedNode<"!="> | UnnamedNode<"%"> | UnnamedNode<"&"> | UnnamedNode<"&&"> | UnnamedNode<"*"> | UnnamedNode<"+"> | UnnamedNode<"-"> | UnnamedNode<"/"> | UnnamedNode<"<"> | UnnamedNode<"<<"> | UnnamedNode<"<="> | UnnamedNode<"=="> | UnnamedNode<">"> | UnnamedNode<">="> | UnnamedNode<">>"> | UnnamedNode<"^"> | UnnamedNode<"|"> | UnnamedNode<"||">;
...
export interface PreprocElifNode extends NamedNodeBase {
  ...
  conditionNode: BinaryExpressionNode | CallExpressionNode | CharLiteralNode | IdentifierNode | NumberLiteralNode | ParenthesizedExpressionNode | PreprocDefinedNode | UnaryExpressionNode;
}
...
export interface PreprocIncludeNode extends NamedNodeBase {
  ...
  pathNode: CallExpressionNode | IdentifierNode | StringLiteralNode | SystemLibStringNode;
}
