...
let Application = Application_1 = class Application extends component_1.ChildableComponent {
    ...
    convert(src) {
        ...
        if (!semver.satisfies(typescript.version, Application_1.SUPPORTED_TS_VERSION)) {
            this.logger.warn(`You are running in an unsupported TypeScript version! TypeDoc supports ${Application_1.SUPPORTED_TS_VERSION}`);
        }
